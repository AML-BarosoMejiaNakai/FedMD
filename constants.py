...
CONF_MODELS_BALANCED = {
  "models": [{"model_type": "2_layer_CNN", "params": {"n1": 128, "n2": 256, "dropout_rate": 0.2}, "train_params": {"optimizer": "Adam", "lr": 1e-3}},
              ...
              {"model_type": "ResNet20", "params": {"option": "A"}, "train_params": {"optimizer": "SGD", "lr": 1e-1, "weight_decay": 1e-4, "momentum": 0.9}},
              {"model_type": "ResNet20", "params": {"option": "B"}, "train_params": {"optimizer": "SGD", "lr": 1e-1, "weight_decay": 1e-4, "momentum": 0.9}},
              {"model_type": "ResNet20", "params": {"option": "B"}, "train_params": {"optimizer": "SGD", "lr": 1e-1, "weight_decay": 1e-4, "momentum": 0.9}},
              {"model_type": "ResNet20", "params": {"option": "B"}, "train_params": {"optimizer": "SGD", "lr": 1e-1, "weight_decay": 1e-4, "momentum": 0.9}},
            ],
